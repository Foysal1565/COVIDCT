...
plt.show()
plt.gcf()
plt.savefig('/content/drive/MyDrive/ML/COVID_19_DATA/Images/CNN_V1/1.png',  dpi=300)
...
checkpoint = ModelCheckpoint('/content/drive/MyDrive/ML/COVID_19_DATA/Images/CNN_V1/cnn.h5', verbose=1, save_best_only=True)
...
model = load_model('/content/drive/MyDrive/ML/COVID_19_DATA/Images/CNN_V1/cnn.h5')
...
plt.savefig('/content/drive/MyDrive/ML/COVID_19_DATA/Images/CNN_V1/2.png' , dpi=300)
...
# accuracy plot 
plt.plot(hist.history['accuracy'], color='red', marker = 'o', markevery=50, ms = 20, linewidth = '3.5')
plt.plot(hist.history['val_accuracy'], color='black',marker = 'o', markevery=50, ms = 20, linewidth = '3.5')
...
plt.savefig('/content/drive/MyDrive/ML/COVID_19_DATA/Images/CNN_V1/3.png', dpi=300)
...
# accuracy plot 
plt.plot(hist.history['loss'], color='red', marker = 'o', markevery=50, ms = 20, linewidth = '3.5')
plt.plot(hist.history['val_loss'], color='black',marker = 'o', markevery=50, ms = 20, linewidth = '3.5')
...
plt.xticks(fontsize=35)
plt.yticks(fontsize=35)
plt.savefig('/content/drive/MyDrive/ML/COVID_19_DATA/Images/CNN_V1/4.png',  dpi=300)
...
plt.grid(color = 'gray', linestyle = '--', linewidth = 0.5)
plt.savefig('/content/drive/MyDrive/ML/COVID_19_DATA/Images/CNN_V1/5.png',  dpi=300)
